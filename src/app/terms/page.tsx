    ...
    <div className="bg-[var(--color-background)] min-h-screen selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen">
        ...
        <div className="prose prose-lg text-gray-600 font-medium">
          ...
          <p className="mb-8">
            These Terms & Conditions govern your use of <strong>saasvideo.online</strong>. By accessing or using our platform, you agree to be bound by these terms. If you disagree with any part of these terms, you may not access the service.
          </p>
          ...
          <p className="mb-8">
            If you have any questions regarding these terms, please contact us at <a href="mailto:hello@saasvideo.online" className="text-indigo-600 hover:underline">hello@saasvideo.online</a>.
          </p>
        </div>
      </main>
      <Footer />
