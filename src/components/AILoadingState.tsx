...
const TASK_SEQUENCES = [
    {
        ...
        lines: [
            ...
            "Contextualizing cinematic narrative...",
            "Mapping high-fidelity motion beats...",
            "Preparing React/Remotion manifest...",
            "Identifying premium feature highlights...",
        ],
    },
    { 
        status: "Synthesizing Audio",
        lines: [
            "Initializing Realistic Voiceover engine...",
            "Calibrating high-fidelity speech bytes...",
            "Mapping cinematic SFX whip-transitions...",
            "Calculating automatic audio ducking...",
            "Syncing click-haptics with cursor paths...",
            "Optimizing bitrates for browser audio...",
        ],
    },
    { 
        status: "Forging Visuals",
        lines: [
            "Crafting high-inertia camera springs...",
            "Synthesizing 3D glassmorphic mockups...",
            "Applying 45-degree light sweep shaders...",
            "Injecting dynamic SVG kinetic paths...",
            "Configuring frame-accurate tweening...",
            "Finalizing cinematic animation logic...",
        ],
    },
    {
        status: "Polishing Fidelity",
        lines: [
            "Enhancing HDR lighting and shadows...",
            "Refining backdrop blur refraction...",
            "Reviewing per-character typography bloom...",
            "Validating velocity-based motion blur...",
            "Testing pixel-perfect UI replication...",
            "Adding subtle background bokeh depth...",
            "Finalizing premium studio export...",
        ],
    },
];
