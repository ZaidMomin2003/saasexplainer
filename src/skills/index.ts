...
import cinematicCameraSkill from "./cinematic-camera.md";
import uiExplainerSkill from "./ui-explainer.md";
...
- saas-mockups: browser windows, computer screens, app dashboards, website previews, MacOS-style windows, glassmorphism UI
- cursors: mouse movement, cursor clicking, interactive app demos, simulated user interactions, mouse hover
- storyboarding: second-by-second timeline, scene-based planning, frame-accurate control, narrative mapping, technical animation blueprint
- timing: professional motion curves, easing, spring interpolation, staggered animations, non-janky motion
- fonts: brand typography, Google Fonts, theme-consistent text, font family selection
- audio: sound effects (SFX), background music, voiceover synchronization, audio volume fades
- cinematic-camera: premium pan/zoom effects, After Effects style motion, whip-pans with blur, virtual camera state, coordinate-based transforms
- ui-explainer: component highlighting, "popping" UI elements out of a dashboard, focus effects, Z-axis displacement, spotlighting features
